        ...
        for (int i = WBOUND; i < EBOUND; i ++) {
            for (int k = SBOUND; k < NBOUND; k ++) {
                if (ff[i][k] == FLUID) {
                    ...
                    // if (i == WBOUND && k == SBOUND) {
                    //     // printf("\r%d %d %d %d", BTP[ee1], BTP[ew1], BTP[en1], BTP[es1]);
                    //     // printf("\r%.8lf %.8lf %.8lf %.8lf %.8lf", pie1, piw1, pic0, pin1, pis1);
                    //     // printf("\r%.8lf %.8lf %.8lf %.8lf %.8lf", piN[i + 1][k    ], piN[i - 1][k    ], piN[i    ][k    ], piN[i    ][k + 1], piN[i    ][k - 1]);
                    // }
                    ...
                    picc = (psi - ae1 * pie1 - aw1 * piw1 - an1 * pin1 - as1 * pis1) / ac0;
                    res  = omega * (picc - pic0);
                    pic0 = pic0 + res;
                    R    = R + res * res;
